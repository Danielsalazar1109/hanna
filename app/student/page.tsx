...
export default function StudentQueueTicketPage() {
  ...
  const [confirmation, setConfirmation] = useState<BookingResponse["appointment"] | null>(
    null
  );
  ...
  if (confirmation) {
    const issuedAt = formatDateTime(confirmation.createdAt);
        ...
        <div className="w-full max-w-2xl">
          <div className="rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              ...
              <button
                type="button"
                onClick={() => downloadHtml(`ticket-${confirmation.ticketNumber}.html`, html)}
      ...
      <div className="w-full max-w-2xl">
        <div className="rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
          ...
          <p className="mt-2 text-sm leading-6 text-zinc-600 dark:text-zinc-400">
            Enter your details to generate a ticket number. Tickets are served in order.
          </p>
